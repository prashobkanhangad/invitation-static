...
const photos = [
  ...
  {
    src: "/manjima/WhatsApp Image 2026-04-08 at 13.29.32 (1).jpeg",
    alt: "Wedding moment",
  },
  {
    src: "/manjima/WhatsApp Image 2026-04-08 at 13.29.32 (2).jpeg",
    alt: "Beautiful memory",
  },
  {
    src: "/manjima/WhatsApp Image 2026-04-08 at 13.29.32.jpeg",
    alt: "Special occasion",
  },
  {
    src: "/manjima/WhatsApp Image 2026-04-08 at 13.29.33 (1).jpeg",
    alt: "Cherished moment",
  },
  {
    src: "/manjima/WhatsApp Image 2026-04-08 at 13.29.33 (2).jpeg",
    alt: "Celebration",
  },
  {
    src: "/manjima/WhatsApp Image 2026-04-08 at 13.29.33.jpeg",
    alt: "Joyful memory",
  },
  {
    src: "/manjima/WhatsApp Image 2026-04-08 at 13.29.34 (1).jpeg",
    alt: "Beautiful day",
  },
];
    ...
    <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 sm:mb-10 md:mb-12 animate-fade-in-up">
          ...
          />
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-[#9e1c12] mb-2 sm:mb-3 drop-shadow-sm">
            Some Sneak Peaks
          </h2>
          <p className="text-[#654321] text-sm sm:text-base md:text-lg mt-2 sm:mt-4 font-medium">
