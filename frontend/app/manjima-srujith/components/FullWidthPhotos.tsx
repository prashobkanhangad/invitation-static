const groomImage = "/manjima/WhatsApp Image 2026-04-08 at 13.29.34 (2).jpeg";
const brideImage = "/manjima/WhatsApp Image 2026-04-08 at 13.29.34 (3).jpeg";

export const FullWidthPhotos = () => {
  const slides = [
    { src: groomImage, label: "Srujith" },
    { src: brideImage, label: "Manjima", classes: "object-[50%_32%]" },
  ];
    ...
    <section className="space-y-0 text-white">
      {slides.map((item, index) => (
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#9e1c12]/70 via-[#B8860B]/30 to-[#CD853F]/10" />
