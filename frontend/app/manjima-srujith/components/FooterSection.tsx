const footerImage = "/manjima/WhatsApp Image 2026-04-08 at 13.29.36.jpeg";
...
export const FooterSection = () => {
  return (
    <footer className="mt-0">
      ...
      <div className="bg-white text-[#2C2C2C] border-t-2 border-[#D4AF37]/40 shadow-lg">
        <div className="mx-auto flex max-w-5xl flex-col gap-2 sm:gap-3 px-4 sm:px-6 py-4 sm:py-6 text-center text-xs sm:text-sm uppercase tracking-[0.25em] sm:tracking-[0.35em] md:flex-row md:items-center md:justify-between md:text-base">
          <a
            ...
            className="text-[#9e1c12] transition-colors duration-300 hover:text-[#B8860B] font-semibold"
          >
