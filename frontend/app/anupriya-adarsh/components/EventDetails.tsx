      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mb-10 sm:mb-12 md:mb-16">
          <div className="p-6 sm:p-8 md:p-10 text-center space-y-3 sm:space-y-4 shadow-xl border-2 border-[#D4AF37]/40 rounded-2xl sm:rounded-3xl bg-white animate-fade-in-up hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]">
            ...
            <h3 className="text-xl sm:text-2xl md:text-3xl font-serif text-[#9e1c12] font-semibold">Wedding Ceremony</h3>
            <div className="space-y-1 sm:space-y-2">
              <p className="text-3xl sm:text-4xl font-serif text-[#B8860B] font-bold drop-shadow-sm">10</p>
              ...
              <p className="text-sm sm:text-base text-[#654321]">1201 Dhanu 26</p>
            </div>
            <div className="pt-3 sm:pt-4 space-y-2 border-t border-[#9e1c12]/30 mt-4 sm:mt-6">
              <div className="flex items-center justify-center gap-2 text-[#654321] text-sm sm:text-base">
                ...
                <span className="leading-tight">Nakshathra Auditorium, Aingoth, Kanhangad</span>
              </div>
              <div className="flex items-center justify-center gap-2 text-[#654321] text-sm sm:text-base">
                <Clock className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0 text-[#9e1c12]" />
                <span>Muhurtham: 11:00 AM – 11:50 AM</span>
              </div>
            </div>
          </div>
        </div>
