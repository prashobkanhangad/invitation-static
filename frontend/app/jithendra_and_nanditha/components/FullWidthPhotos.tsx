const groomImage = "/jithendra-naditha/img-1.jpeg";
const brideImage = "/jithendra-naditha/img-2.jpeg";

export const FullWidthPhotos = () => {
  const slides = [
    { src: groomImage, label: "Jithendra" },
    { src: brideImage, label: "Nanditha", classes: "object-[50%_32%]" },
  ];
