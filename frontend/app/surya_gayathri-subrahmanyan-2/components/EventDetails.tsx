        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="p-8 md:p-10 text-center space-y-4 shadow-lg border border-primary/20 rounded-3xl bg-card animate-fade-in-up">
            ...
            <div className="space-y-2">
              <p className="text-4xl font-serif text-primary font-bold">13</p>
              <p className="text-xl text-muted-foreground">December 2025</p>
              <p className="text-lg text-muted-foreground">Saturday</p>
            </div>
            <div className="pt-4 space-y-2 border-t border-border mt-6">
              <div className="flex items-center justify-center gap-2 text-muted-foreground">
                <MapPin className="w-5 h-5" />
                <span>Dream Palace Auditorium, Thaliparamba</span>
              </div>
              <div className="flex items-center justify-center gap-2 text-muted-foreground">
          ...
          <div className="p-8 md:p-10 text-center space-y-4 shadow-lg border border-primary/20 rounded-3xl bg-card animate-fade-in-up">
            <Calendar className="w-12 h-12 mx-auto text-primary" />
            <h3 className="text-2xl md:text-3xl font-serif text-foreground">Reception</h3>
            <div className="space-y-2 text-muted-foreground">
              <p className="text-lg">Time</p>
              <p className="text-2xl font-serif text-primary">6:00 PM onwards</p>
              <p className="text-base">Followed by dinner</p>
            </div>
            <div className="pt-4 space-y-3 border-t border-border mt-6 text-muted-foreground">
              <div className="flex items-center justify-center gap-2">
                <MapPin className="w-5 h-5" />
                <span className="text-sm">Gokulam Muchilote</span>
              </div>
              <div className="flex items-center justify-center gap-2">
                <span className="text-xs text-center">Near Cherichal Muthappan Temple, Kizhakkumkara, Kanhangad</span>
              </div>
            </div>
          </div>
        </div>
