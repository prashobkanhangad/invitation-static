...
const rotatingTexts = [
  { prefix: "Namaskaram", main: "I am Anjana" },
  { prefix: "and I am", main: "Jishnu" },
  { prefix: "Our wedding day", main: "13 · 09 · 2026" },
];
          ...
          <div className="text-center max-w-5xl mx-auto space-y-6 sm:space-y-8 animate-fade-in-up">
            ...
            <div className="mt-8 sm:mt-10">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#7A2430] via-[#9B3A48] to-[#7A2430] backdrop-blur-sm px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-semibold text-white shadow-2xl transition-all duration-300 hover:from-[#9B3A48] hover:via-[#C4A574] hover:to-[#9B3A48] hover:scale-105 hover:shadow-3xl border border-[#C4A574]/40"
              >
