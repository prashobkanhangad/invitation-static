    ...
    <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-10 sm:mb-12 md:mb-16 animate-fade-in-up">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-[#9e1c12] mb-2 sm:mb-4 drop-shadow-sm">When & Where</h2>
        ...
        <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mb-10 sm:mb-12 md:mb-16">
          <div className="p-6 sm:p-8 md:p-10 text-center space-y-3 sm:space-y-4 shadow-xl border-2 border-[#D4AF37]/40 rounded-2xl sm:rounded-3xl bg-white animate-fade-in-up hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]">
            ...
            <h3 className="text-xl sm:text-2xl md:text-3xl font-serif text-[#9e1c12] font-semibold">Marriage Ceremony</h3>
            <div className="space-y-1 sm:space-y-2">
              <p className="text-3xl sm:text-4xl font-serif text-[#B8860B] font-bold drop-shadow-sm">21</p>
              <p className="text-lg sm:text-xl text-[#9e1c12] font-medium">January 2026</p>
              <p className="text-base sm:text-lg text-[#654321]">Wednesday</p>
            </div>
          ...
          <div className="p-6 sm:p-8 md:p-10 text-center space-y-3 sm:space-y-4 shadow-xl border-2 border-[#D4AF37]/40 rounded-2xl sm:rounded-3xl bg-white animate-fade-in-up hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]">
            ...
            <h3 className="text-xl sm:text-2xl md:text-3xl font-serif text-[#9e1c12] font-semibold">Wedding Reception</h3>
            <div className="space-y-1 sm:space-y-2">
              <p className="text-3xl sm:text-4xl font-serif text-[#B8860B] font-bold drop-shadow-sm">25</p>
              <p className="text-lg sm:text-xl text-[#9e1c12] font-medium">January 2026</p>
        ...
        <div className="text-center animate-fade-in-up">
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-serif text-[#9e1c12] mb-4 sm:mb-6 drop-shadow-sm">Countdown Begins to Our Special Day!</h3>
          <p className="text-[#9e1c12] mb-6 sm:mb-8 text-sm sm:text-base font-medium">We're almost there—save the moment with us.</p>
