...
const togetherImage = "/jithendra-naditha/img-4.jpeg";
    ...
    <section className="py-16 md:py-24 px-4 bg-gradient-to-b from-secondary/30 to-background">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <h2 className="text-4xl md:text-5xl font-serif text-foreground">Jithendra & Nanditha</h2>
        ...
        <div className="space-y-12">
          <div className="bg-card p-8 md:p-10 rounded-2xl shadow-lg animate-fade-in-up border border-border/50">
            ...
            <p className="text-primary font-medium text-right">— Nanditha</p>
          </div>
          ...
          <div className="bg-card p-8 md:p-10 rounded-2xl shadow-lg animate-fade-in-up border border-border/50">
            ...
            <p className="text-primary font-medium text-right">— Jithendra</p>
          </div>
        </div>

        <div className="text-center mt-12 animate-fade-in-up">
          <p className="text-2xl md:text-3xl font-serif text-foreground">
            Periya will ring with our wedding bells on{" "}
            <span className="text-primary font-bold">30.11.2025</span>
          </p>
        </div>
        ...
        <div className="mt-10 overflow-hidden rounded-3xl shadow-2xl animate-fade-in-up">
          <div className="relative h-[60vh] w-full md:h-[75vh] lg:h-[90vh]">
            <img
              src={togetherImage}
              alt="Jithendra & Nanditha together"
