const mapLink = "https://maps.app.goo.gl/?q=Sumangali+Auditorium+Periya";
const embedUrl = "https://www.google.com/maps?q=Sumangali+Auditorium+Periya&output=embed";
    ...
    <section className="py-16 md:py-24 px-4 bg-gradient-to-b from-muted/40 to-background">
      <div className="max-w-5xl mx-auto space-y-8 text-center">
        <div className="space-y-4">
          ...
          <h2 className="text-4xl md:text-5xl font-serif text-foreground">Sumangali Auditorium</h2>
          <p className="text-muted-foreground text-base md:text-lg">
            Periya, Kerala · Tap below to open directions
          </p>
        </div>

        <div className="overflow-hidden rounded-3xl shadow-2xl border border-border/40">
          <iframe
            title="Sumangali Auditorium Location"
            src={embedUrl}
            width="100%"
            height="420"
            loading="lazy"
