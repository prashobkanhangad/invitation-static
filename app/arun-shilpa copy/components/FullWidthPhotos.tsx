const groomImage = "/arun-shilpa/img-2.jpeg";
const brideImage = "/arun-shilpa/img-4.jpeg";

export const FullWidthPhotos = () => {
  const slides = [
    { src: groomImage, label: "Arun" },
    { src: brideImage, label: "Shilpa", classes: "object-[50%_32%]" },
  ];
