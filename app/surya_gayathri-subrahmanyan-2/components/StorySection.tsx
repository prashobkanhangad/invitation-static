...
const togetherImage = "/sanath/img-4.jpeg";
    ...
    <section className="py-16 md:py-24 px-4 bg-gradient-to-b from-secondary/30 to-background">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <h2 className="text-4xl md:text-5xl font-serif text-foreground">Sanath & Shreya</h2>
        ...
        <div className="space-y-12">
          <div className="bg-card p-8 md:p-10 rounded-2xl shadow-lg animate-fade-in-up border border-border/50">
            ...
            <p className="text-primary font-medium text-right">— Shreya</p>
          </div>
          ...
          <div className="bg-card p-8 md:p-10 rounded-2xl shadow-lg animate-fade-in-up border border-border/50">
            ...
            <p className="text-primary font-medium text-right">— Sanath</p>
          </div>
        </div>
        ...
        <div className="text-center mt-12 animate-fade-in-up">
          <p className="text-2xl md:text-3xl font-serif text-foreground">
            ...
            <span className="text-primary font-bold">13.12.2025</span>
          </p>
        </div>
