const mapLink = "https://maps.app.goo.gl/?q=Dream+Palace+Auditorium+Thaliparamba";
const embedUrl = "https://www.google.com/maps?q=Dream+Palace+Auditorium+Thaliparamba+Kannur&output=embed";
    ...
    <section className="py-16 md:py-24 px-4 bg-gradient-to-b from-muted/40 to-background">
      <div className="max-w-5xl mx-auto space-y-8 text-center">
        <div className="space-y-4">
          ...
          <h2 className="text-4xl md:text-5xl font-serif text-foreground">Dream Palace Auditorium</h2>
