...
export const InvitationSection = () => {
  return (
    <section className="pt-12 sm:pt-16 md:pt-24 pb-0 px-4 sm:px-6 bg-gradient-to-b from-[#F5DEB3] via-[#FFF8DC] to-[#F5E6D3]">
      <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
        <img src={floralDivider} alt="" className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-6 sm:mb-8 opacity-70" />

        <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-[#8B0000] mb-4 sm:mb-6 md:mb-8 px-4 drop-shadow-sm">
        ...
        <div className="mt-8 sm:mt-10 md:mt-12 flex items-center justify-center gap-2 sm:gap-3 px-4">
          <Heart className="w-5 h-5 sm:w-6 sm:h-6 text-[#8B0000] fill-[#8B0000] animate-pulse" />
          <p className="text-xl sm:text-2xl md:text-3xl font-serif text-[#8B0000] font-semibold drop-shadow-sm">Sanath & Shreya</p>
          <Heart className="w-5 h-5 sm:w-6 sm:h-6 text-[#8B0000] fill-[#8B0000] animate-pulse" />
        </div>
        ...
        <div className="mt-6 sm:mt-8 space-y-2 sm:space-y-3 px-4">
          ...
          <p className="text-[#8B4513] text-xs sm:text-sm md:text-base italic max-w-xl mx-auto">
            "Your gracious presence and blessings will make the occasion truly special."
          </p>
        </div>
      </div>
    </section>
