...
export const EventDetails = () => {
  ...
  useEffect(() => {
    const weddingDate = new Date("2025-11-23T10:50:00").getTime();
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="p-8 md:p-10 text-center space-y-4 shadow-lg border border-primary/20 rounded-3xl bg-card animate-fade-in-up">
            ...
            <div className="space-y-2">
              <p className="text-4xl font-serif text-primary font-bold">23</p>
            ...
            <div className="pt-4 space-y-2 border-t border-border mt-6">
              <div className="flex items-center justify-center gap-2 text-muted-foreground">
                ...
                <span>Sreeprabha Auditorium, Payyannur</span>
              </div>
              <div className="flex items-center justify-center gap-2 text-muted-foreground">
          ...
          <div className="p-8 md:p-10 text-center space-y-4 shadow-lg border border-primary/20 rounded-3xl bg-card animate-fade-in-up">
            ...
            <div className="space-y-2 text-muted-foreground">
              ...
              <p className="text-2xl font-serif text-primary">7th Vrishchikam 1201</p>
            </div>
            <div className="pt-4 space-y-3 border-t border-border mt-6 text-muted-foreground">
              ...
              <div className="flex items-center justify-center gap-2">
                <span className="text-sm uppercase tracking-wide">Nakshatra / Rasi:</span>
                <span className="font-medium text-foreground">Makaram Rasi</span>
              </div>
            </div>
          </div>
        </div>
