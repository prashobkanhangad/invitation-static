...
const heroImage = "/modern/hero.jpg";

const rotatingTexts = [
  { prefix: "Namaskaram", main: "I'm Subrahmanyan" },
  { prefix: "and I am", main: "Surya Gayathri" },
  { prefix: "We're tying the knot", main: "23 · 11 · 2025" },
];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto animate-fade-in-up">
        ...
        <div className="mt-12">
          <a
            href="https://maps.app.goo.gl/JY2NPgnmfwb9epda7?g_st=ipc"
            target="_blank"
