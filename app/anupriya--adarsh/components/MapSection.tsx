const weddingMapLink = "https://www.google.com/maps/search/?api=1&query=Nakshathra+Auditorium+Aingoth+Kanhangad";
const weddingEmbedUrl = "https://www.google.com/maps?q=Nakshathra+Auditorium+Aingoth+Kanhangad&output=embed";
      ...
      <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-20">
        ...
        <div className="space-y-6 sm:space-y-8 text-center">
          <div className="space-y-3 sm:space-y-4">
            <p className="text-xs sm:text-sm uppercase tracking-[0.3em] sm:tracking-[0.4em] text-[#9e1c12] font-semibold">Wedding Ceremony Venue</p>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-[#9e1c12] px-4 drop-shadow-sm">Nakshathra Auditorium</h2>
            <p className="text-[#654321] text-sm sm:text-base md:text-lg px-4 leading-relaxed font-medium">
              Aingoth, Kanhangad · Tap below to open directions
            </p>
          </div>
          ...
          <div className="overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl border-2 border-[#DAA520]/40 hover:shadow-3xl transition-shadow duration-300">
            <iframe
              title="Nakshathra Auditorium Location"
              src={weddingEmbedUrl}
              width="100%"
              height="320"
              loading="lazy"
