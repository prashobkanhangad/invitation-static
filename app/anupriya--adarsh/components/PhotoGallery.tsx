...
const photos = [
  { src: "/adarsh/img-12.jpeg", alt: "Wedding celebration" },
  { src: "/adarsh/img-3.jpeg", alt: "Wedding moment" },
  { src: "/adarsh/img-4.jpeg", alt: "Beautiful memory" },
  { src: "/adarsh/img-5.jpeg", alt: "Special occasion" },
  { src: "/adarsh/img-6.jpeg", alt: "Cherished moment" },
  { src: "/adarsh/img-7.jpeg", alt: "Celebration" },
  { src: "/adarsh/img-8.jpeg", alt: "Joyful memory" },
  { src: "/adarsh/img-9.jpeg", alt: "Beautiful day" },
];
    ...
    <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 sm:mb-10 md:mb-12 animate-fade-in-up">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-[#9e1c12] mb-2 sm:mb-3 drop-shadow-sm">Some Sneak Peaks</h2>
