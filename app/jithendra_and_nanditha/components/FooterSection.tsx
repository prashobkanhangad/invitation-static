const footerImage = "/jithendra-naditha/img-5.jpeg";

export const FooterSection = () => {
  return (
    <footer className="mt-16">
      <div className="relative w-full overflow-hidden">
        <img src={footerImage} alt="Jithendra & Nanditha" className="h-[320px] w-full object-cover md:h-[480px]" />
      </div>
